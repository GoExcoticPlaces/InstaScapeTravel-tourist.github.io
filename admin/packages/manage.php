...
<div class="card card-outline card-secondary">
		...
		<form action="" id="package-form">
            ...
            ?>
                <div class="d-flex w-100 align-items-center img-item">
                    ...
                    <span class="ml-4"><button class="btn btn-sm btn-default text-secondary rem_img" type="button" data-path="<?php echo base_app.$upload_path.'/'.$img ?>"><i class="fa fa-trash"></i></button></span>
                </div>
            <?php endforeach; ?>
            <?php endif; ?>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-secondary" form="package-form">Save</button>
		<a class="btn btn-flat btn-secondary" href="?page=responses">Cancel</a>
	</div>
</div>
<script>

...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-light-dark elevation-4 bg-secondary text-white">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link bg-secondary text-sm">
        <img src="<?php echo validate_image($_settings->info('logo'))?>" alt="Store Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width: 3.5rem;height: 3.5rem;max-height: unset">
